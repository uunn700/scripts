...
def U01():
    report_data = {
        ...
        "중요도": "상",
        "결과": "", 
        "서버": "58814d56-48b0-5981-048e-04f9f5a1a8a4",
        "점검자": "김가현"  
    }    
...
def U52():
    ...
    if isSafe and "결과" not in report_data:
        report_data["결과"] = "양호"
...
def U53():
    ...
    try:
        ...
        if isNologin and "결과" not in report_data:
            report_data["결과"] = "양호"
...
# 결과 요약을 final_report에 추가
    ...
    # json_file_path = 'check_results.json'
